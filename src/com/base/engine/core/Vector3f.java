...
public class Vector3f 
{
	...
	public Vector3f rotate(BennyQuaternion rotation)
	{
		BennyQuaternion conjugate = rotation.conjugate();

		BennyQuaternion w = rotation.mul(this).mul(conjugate);
	...
	public void print()
	{
		System.out.println("Vector2f: " + x + ", " + y + ", " + z);
	}
}
