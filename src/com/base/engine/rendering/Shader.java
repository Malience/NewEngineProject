...
import com.base.engine.rendering.MeshLoading.ResourceManagement.*;
...
public class Shader
{
	...
	public void updateUniforms(Transform transform, Material material, RenderingEngine renderingEngine)
	{
		...
		Matrix MVPMatrix = renderingEngine.getCamera(0).getViewProjection().mul(worldMatrix);
		...
		for(int i = 0; i < resource.getUniformNames().size(); i++)
		{
			...
			else if(uniformName.startsWith("C_"))
			{
				...
				{
					setUniform(uniformName, renderingEngine.getCamera(0).getTransform().getTransformedPos());
				}
				else
